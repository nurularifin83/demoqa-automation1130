...
export default class TextBoxPage extends BasePage {
  ...
  async enterTextBox(name: string, email: string, currentAddress: string, permanentAddress: string): Promise<void> {
  ...
  async verifyDisplayName(expectedText: string): Promise<boolean> {
    try {
